...
def main():
    ...
    arg_dict = {
        ...
        'output_root': '/home/grt/GloFE/OpenASL/mmpose',
        'args': args,
    }

    all_samples = load_sample_names('/home/grt/GloFE/tools/youtube_asl_samples.txt')
...
def process_single_video(video_path, arg_dict):
    ...
    print(f'Running inference on {sample_id}')
